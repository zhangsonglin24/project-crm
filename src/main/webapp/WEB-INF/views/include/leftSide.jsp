...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" ${fn:startsWith(param.menu,"admin_") ? 'active' : ''}>
                <a href="javascript:;"><i class="fa fa-cogs"></i> <span>系统管理</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="${param.menu == 'admin_emp' ? 'active' : ''}">
                        <a href="/admin/users">员工管理</a>
                    </li>
                    <li class="${param.menu == 'admin_sys' ? 'active' : ''}">
                        <a href="#">系统设置</a>
                    </li>
                </ul>
            </li>
